...
> - **Source:** https://github.com/NikoDemon80/ComfyUI-H3-Motion-Context (README at repo root)
> - **Fetched:** 2026-09-16 (hygiene pass 2, Flux zbn31xs)
> - **Pinned at:** main @ `5335715abe54c1a9bfbe3494da29aae3e8635ce3` (pushed 2026-09-06)
> - **License:** repo is **GPL-3.0** — under our license doctrine this is reference-reading only; the pack itself is user-fetch, never vendored, and this copy never ships
> - **Load-bearing because:** the 12-citation source for latent chaining — Save/Load Latent pair, context_length 22 / audio_context_length 24 recommendation, 32 kHz audio trap, turbo/Spectrum audio-degradation warning, the airlock prompting pattern, and the layout-contract refusal philosophy our own checks mirror.
> - **Local reliance:** docs/research/*latent-continue* and the chaining-feature design patterns adopted in 3b4225a (hash-bound latent binding, frozen-audio-prefix). Check vs source before acting on any chaining behavior detail.
