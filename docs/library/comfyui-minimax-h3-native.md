...
> - **Source:** https://docs.comfy.org/tutorials/video/minimax/minimax-h3-native (markdown served at …/minimax-h3-native.md)
> - **Fetched:** 2026-09-16 (hygiene pass 2, Flux zbn31xs)
> - **Pinned at:** unversioned docs site (Mintlify); the served `.md` was fetched verbatim
...
> - **Load-bearing because:** the most-cited external URL in our research docs (17 in-tree citations) — T2V/I2V/R2V template semantics, turbo LoRA names/step counts, reference limits (9 images / 3 videos / 3 audios), ref_image_size match-vs-max, and the two advanced primitives: `MiniMaxH3AddGuide` any-frame anchoring (ComfyUI#15439) and per-token latent noise masks (ComfyUI#15375).
> - **Local reliance:** the latent-chaining line of research (wan2gp-h3-latent-continue, Motion-Context adoption) builds directly on the anchoring + masking primitives documented here. Check vs source whenever ComfyUI updates change node behavior.
