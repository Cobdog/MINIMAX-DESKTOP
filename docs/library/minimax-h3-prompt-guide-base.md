...
> - **Source:** https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/docs/VIDEO_PROMPT_WRITING_GUIDE_base_en.md
> - **Fetched:** 2026-09-16 (hygiene pass 2, Flux zbn31xs)
> - **Pinned at:** MiniMaxAI/MiniMax-H3 repo sha `42ed227ee7df40d41602854ae760620d6eb651fe` (lastModified 2026-08-13)
> - **License:** part of the MiniMax-H3 model repo, `license: other` (MiniMax community license — see the repo's `LICENSE` and `docs/QA-about-License.md`; reportedly does not cover EU/UK/KR/US commercial use)
> - **Load-bearing because:** the official base-mode prompt grammar (shots, camera, speakers, sound) behind our `composeH3Prompt` / promptPolicies implementation and every ecosystem research doc's prompting section.
> - **Local reliance:** docs/research/*.md prompting sections; src/lib/promptPolicies.ts; the AutoContext temporal-exclusivity guidance (8b6a6e1). Check vs source when prompting behavior drifts.
