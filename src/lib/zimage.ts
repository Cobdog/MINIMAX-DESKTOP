...
export function buildZImage(prompt: string, width: number, height: number, seed: number, model: string, encoder: string, vae: string, steps = 8, cfg = 1, variant: ZImageVariant = 'turbo', negativePrompt = ''): ComfyPrompt {
  return {
